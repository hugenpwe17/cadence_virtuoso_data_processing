#ifndef RTW_HEADER_phase_magrin_acc_private_h_
#define RTW_HEADER_phase_magrin_acc_private_h_
#include "rtwtypes.h"
...
int_T * maxNewBufSzPtr ) ; real_T phase_magrin_acc_rt_TDelayInterpolate (
