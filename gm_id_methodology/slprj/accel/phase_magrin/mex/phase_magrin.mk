...
MAKECMD         = /home/oyxl/Software/Matlab/R2022a/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = phase_magrin
MODULES                 = phase_magrin_acc.c phase_magrin_acc_data.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/phase_magrin_acc.mexa64
MAKEFILE                = phase_magrin.mk
MATLAB_ROOT             = /home/oyxl/Software/Matlab/R2022a
ALT_MATLAB_ROOT         = /home/oyxl/Software/Matlab/R2022a
START_DIR               = /home/oyxl/Desktop/cadence_virtuoso_data_processing/gm_id_methodology
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNXA64
...
COMPILE_FLAGS_OTHER     = -msse2 -Wno-implicit-function-declaration
SYSTEM_LIBS             = -L"/home/oyxl/Software/Matlab/R2022a/bin/glnxa64" -lmwipp -lut -lmwmathutil -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwsl_fileio -lmwsigstream -lmwslexec_simlog -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsimulink -lmwslexec_simbridge -lmwstringutil -lemlrt -lmwslio_core -lmwslio_clients -lmwsl_services -lmx -lmex
...
MODELLIB                  = phase_magrin_acc.mexa64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/phase_magrin \
...
phase_magrin_acc.o : $(START_DIR)/slprj/accel/phase_magrin/phase_magrin_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/phase_magrin/phase_magrin_acc.c

phase_magrin_acc_data.o : $(START_DIR)/slprj/accel/phase_magrin/phase_magrin_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/phase_magrin/phase_magrin_acc_data.c
